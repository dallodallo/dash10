...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="bei.jpg", top=True),
                dbc.CardBody(
                    [
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="box.jpg", top=True),
                dbc.CardBody(
                    [
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="bet.jpg", top=True),
                dbc.CardBody(
                    [
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="bes.jpg", top=True),
                dbc.CardBody(
                    [
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="beu.jpg", top=True),
                dbc.CardBody(
                    [
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="beo.jpg", top=True),
                dbc.CardBody(
                    [
    ...
    dbc.Row([
        dbc.Col([
            dbc.CardImg(src="beh.png", top=True),
            dbc.Card([
                dbc.CardBody(
                    [
